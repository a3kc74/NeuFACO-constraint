...
from envs.vrptw_base import Node, VrptwGraph
from solvers.macs import MultipleAntColonySystem
...
def load_gfacs_test_dataset(n_nodes, data_dir=None, tam=False, vrptw=False, map_location="cpu"):
    ...
    if not filename.is_file():
        raise FileNotFoundError(f"File {filename} not found. Generate it with generate_data.py first.")
