import numpy as np
import random
from analysis.macs_vrptw_figure import VrptwAcoFigure
from envs.vrptw_base import VrptwGraph, PathMessage
from solvers.macs_ant import Ant
        ...
        while True:
            ...
            while acs_vehicle_thread.is_alive() and acs_time_thread.is_alive():
                ...
                if time.time() - start_time_found_improved_solution > 60 * given_time:
                    ...
                    self.print_and_write_in_file(file_to_write, 'it takes %0.3f second from macs solver running' % (time.time()-start_time_total))
